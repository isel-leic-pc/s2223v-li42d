public class Singleton {
		 ...
		 *
		 * Unfortunately, not only this version is unsafe for multithreaded access,
		 * there is also a better way to achieve the same effect in Java.
		 *
		...
		public static void main(String[] args) {
			...
			*/
			...
			thread(() -> { sleep(5000); Singleton.getInstance().printInfo("[T4]"); });
		}
